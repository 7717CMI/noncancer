...
export default function CustomerIntelligenceDatabaseWithTabs({}: CustomerIntelligenceDatabaseProps) {
  ...
  return (
    <div className="w-full">
      <h2 className="text-xl font-bold text-black mb-6">Intelligence Database</h2>
